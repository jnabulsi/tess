...
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///home/jn/src/tess/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///home/jn/src/tess/node_modules/devalue/index.js';
import destr from 'file:///home/jn/src/tess/node_modules/destr/dist/index.mjs';
import { withQuery, joinURL, withTrailingSlash, parseURL, withoutBase, getQuery, joinRelativeURL } from 'file:///home/jn/src/tess/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///home/jn/src/tess/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file:///home/jn/src/tess/node_modules/@unhead/ssr/dist/index.mjs';
import { createHooks } from 'file:///home/jn/src/tess/node_modules/hookable/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///home/jn/src/tess/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///home/jn/src/tess/node_modules/unenv/runtime/fetch/index.mjs';
import { klona } from 'file:///home/jn/src/tess/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///home/jn/src/tess/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///home/jn/src/tess/node_modules/scule/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///home/jn/src/tess/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/jn/src/tess/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/jn/src/tess/node_modules/radix3/dist/index.mjs';
import { getContext } from 'file:///home/jn/src/tess/node_modules/unctx/dist/index.mjs';
...
const _egkWDhtPtb = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/home/jn/src/tess";
...
const _lazy_ry0JE8 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_ry0JE8, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_ry0JE8, lazy: true, middleware: false, method: undefined }
];

const serverAssets = [{"baseName":"server","dir":"/home/jn/src/tess/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/jn/src/tess","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/jn/src/tess/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/jn/src/tess/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/jn/src/tess/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/jn/src/tess/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const getClientManifest = () => import('file:///home/jn/src/tess/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///home/jn/src/tess/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
